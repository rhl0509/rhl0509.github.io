...
export const PROJECTS: Project[] = [
  /* real (D:\local_LLM\pretrain) — a language model built from the bottom: own
     ...
     The name is the seed it was grown from, not anything it inherited — and the
     owner means to keep training it past the current ko/en/code mix, so the
     metaphor tracks the roadmap instead of freezing it. That is why the
     Korean-flavoured candidates (KoSeed, 한국어 LLM 사전학습) lost: pinning a
     language into the name goes stale the first time the corpus widens.
